    ...
    <div className="App">
      ...
      <nav className="navbar container">
        <div className="logo">
          ...
          NAME <span style={{ fontWeight: "normal" }}>CHEMICALS</span>
        </div>
        ...
        <ul className={`nav-links ${isMenuOpen ? 'open' : ''}`}>
          ...
          <li className="search-icon"><i className="fas fa-search"></i></li>
          <li><Link to="/inquiry" className="btn-primary" style={{ padding: "10px 20px" }}>INQUIRY NOW</Link></li>
        </ul>
      </nav>
          ...
          <div className="footer-grid">
            <div className="footer-col">
              <div className="logo" style={{ color: "white", marginBottom: "15px" }}>
                <img src="/logo192.png" alt="Logo" style={{ height: "25px", marginRight: "10px" }} />
                NAME <span style={{ fontWeight: "normal" }}>CHEMICALS</span>
              </div>
